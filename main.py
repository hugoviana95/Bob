...
schedule.every().day.at("07:20").do(bob.atualizar_acompanhamento_equipes)
schedule.every().day.at("07:30").do(bob.atualizar_acompanhamento_equipes)
schedule.every().day.at("07:33").do(atualiza_v5)
schedule.every().day.at("07:40").do(bob.atualizar_acompanhamento_equipes)
...
schedule.every().day.at("08:00").do(bob.atualizar_acompanhamento_equipes)
schedule.every().day.at("08:30").do(bob.atualizar_pendencia_asbuilt)
...
schedule.every().day.at("21:50").do(lambda: bob.atualizar_avanco_gpm('conquista'))
schedule.every().day.at("21:52").do(lambda: bob.atualizar_avanco_gpm('barreiras'))
schedule.every().day.at("21:54").do(lambda: bob.atualizar_avanco_gpm('jequié'))
schedule.every().day.at("21:56").do(lambda: bob.atualizar_avanco_gpm('irecê'))
schedule.every().day.at("21:58").do(lambda: bob.atualizar_avanco_gpm('guanambi'))
schedule.every().day.at("22:01").do(lambda: bob.atualizar_avanco_gpm('itapetinga'))
schedule.every().day.at("22:03").do(lambda: bob.atualizar_avanco_gpm('lapa'))
